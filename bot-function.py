...
def send_photos(photos_db_rows, body):
    ...
    for photo_row in photos_db_rows:
        ...
        photo_url = "https://d5dpgfipm12l6htf738o.apigw.yandexcloud.net/orig_photo/" + photo_row['photo']
...
def getUnsignedPhoto():
    ...
    url_photo = 'https://d5dpgfipm12l6htf738o.apigw.yandexcloud.net/static/' + object_id
...
def execute_update_photo(db_id):
    ...
    ydb_client = session.client('dynamodb',
                                endpoint_url='https://docapi.serverless.yandexcloud.net/ru-central1/b1g71e95h51okii30p25/etnssgmht47via84j7j3',
                                aws_access_key_id="...",
