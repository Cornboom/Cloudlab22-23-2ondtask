...
def handler(event, context):
    print("face detection func started")
    ...
    queue_url = queue_client.get_queue_url(QueueName="vvot34-tasks")['QueueUrl']
    ...
    print("face detection ended its work")