...
async def hello(request):
    ...
    new_bucket = 'itis-2022-2023-vvot34-faces'
    ...
    #Write to ydb
    ydb_client = session.client('dynamodb', endpoint_url='https://docapi.serverless.yandexcloud.net/ru-central1/b1g71e95h51okii30p25/etnssgmht47via84j7j3', aws_access_key_id='...', aws_secret_access_key='...')
